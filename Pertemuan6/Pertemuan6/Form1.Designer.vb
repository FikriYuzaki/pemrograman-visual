...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' btnTampilkan
        ' 
        btnTampilkan.Location = New Point(148, 281)
        btnTampilkan.Name = "btnTampilkan"
        btnTampilkan.Size = New Size(109, 36)
        ...
        dgvMahasiswa.Location = New Point(57, 42)
        dgvMahasiswa.Name = "dgvMahasiswa"
        dgvMahasiswa.RowHeadersWidth = 51
        dgvMahasiswa.Size = New Size(300, 188)
        dgvMahasiswa.TabIndex = 1
        ' 
        ' lblNama
        ' 
        lblNama.AutoSize = True
        lblNama.Location = New Point(436, 65)
        ...
        lblNim.Location = New Point(436, 126)
        lblNim.Name = "lblNim"
        ...
        lblJurusan.Location = New Point(436, 186)
        ...
        ' txtNama
        ' 
        txtNama.Location = New Point(542, 65)
        txtNama.Name = "txtNama"
        txtNama.Size = New Size(192, 27)
        txtNama.TabIndex = 5
        ' 
        ' txtNim
        ' 
        txtNim.Location = New Point(542, 126)
        txtNim.Name = "txtNim"
        txtNim.Size = New Size(192, 27)
        txtNim.TabIndex = 6
        ' 
        ' txtJurusan
        ' 
        txtJurusan.Location = New Point(542, 186)
        txtJurusan.Name = "txtJurusan"
        txtJurusan.Size = New Size(192, 27)
        txtJurusan.TabIndex = 7
        ' 
        ' btnTambah
        ' 
        btnTambah.Location = New Point(542, 281)
